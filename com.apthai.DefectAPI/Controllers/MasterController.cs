...
namespace com.apthai.DefectAPI.Controllers
{
    public class MasterController : ControllerBase
    {
        ...
        [HttpPost]
        [Route("GetCreatedDefectByProjectCodeAndUnitVetical")]
        public async Task<object> GetCreatedDefectByProjectCodeAndUnitVetical([FromBody] GetDefectTransactionByUnitID data)
        {
            try
            {
                //bool CanAccess = _authorizeService.AccessKeyAuthentication(data.AccessKey, data.EmpCode);
                ...
                for (int i = 0; i < callTDefect.Count(); i++)
                {
                    ...
                    for (int a = 0; a < callTDefectDetails.Count(); a++)
                    {
                        ...
                        obj.StaComplain = callTDefectDetails[a].StaComplain;
        ...
        [HttpPost]
        [Route("GetCreatedDefectByProjectCodeAndUnitHorizontal")]
